	...
	return (
		<div className="wpcorp-icon-heading">
			...
			<RichText
				...
				placeholder={ __( 'Heading…', 'wpcorp' ) } // Display this text before any content has been added by the user
			/>
			<InspectorControls>
				<PanelBody title={ __( 'Block Settings', 'wpcorp' ) }>
					<RadioControl
						label={ __( 'Select the icon', 'wpcorp' ) }
						help={ __( 'Controls icon selection', 'wpcorp' ) }
						selected={ option }
						options={ [
							{ label: 'Dos', value: 'dos' },
