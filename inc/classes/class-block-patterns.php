...
class Block_Patterns {
	...
	public function register_block_patterns() {
		if ( function_exists( 'register_block_pattern' ) ) {
			...
			register_block_pattern(
				'wpcorp/cover',
				[
					'title' => __( 'WPCorp Cover', 'wpcorp' ),
					'description' => __( 'WPCorp Cover Block with image and text', 'wpcorp' ),
					'categories' => [ 'cover' ],
			...
			register_block_pattern(
				'wpcorp/two-columns',
				[
					'title' => __( 'WPCorp Two Column', 'wpcorp' ),
					'description' => __( 'WPCorp two columns with heading and text', 'wpcorp' ),
					'categories' => [ 'columns' ],
	...
	public function register_block_pattern_categories() {
		...
		$pattern_categories = [
			'cover' => __( 'Cover', 'wpcorp' ),
			'columns' => __( 'Columns', 'wpcorp' ),
		];
